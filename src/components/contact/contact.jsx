    ...
    <div className="bg-black text-white min-h-[200px] pt-[60px] pb-[100px]" id="contact">
      <div className="max-w-[1330px] mx-auto flex flex-wrap gap-1 justify-between pt-[50px] max-sm:justify-center max-lg:justify-center overflow-hidden">
        ...
        <div className="max-w-[300px] w-full flex flex-col pb-5 sm:max-w-[300px] max-lg:text-center">
          <p className="text-[40px] sm:text-[50px] text-white font-bold" data-aos="fade-right">
            {t("contact")}
          </p>
          <hr
            className="w-12 h-[5px] bg-[#ff0000] mt-[5px] border-none max-lg:mx-auto  "
            data-aos="fade-right"
          />
          <p
            className="mt-[20px] sm:mt-[35px] mb-[10px] text-[18px] font-bold"
            data-aos="fade-right"
          >
            {t("for-contact")}
          </p>
          ...
          <ul className="flex flex-col gap-4" data-aos="fade-right">
            <li className="flex items-center gap-2 max-lg:justify-center" data-aos="fade-right">
        ...
        {/* Xarita */}
        <div data-aos="zoom-in" className="max-w-[500px] w-full pb-5 px-2">
          <iframe
        ...
        <form
          id="form"
          className="flex flex-col gap-5 max-w-[350px] w-full pb-5 px-2 sm:max-w-[500px]"
          onSubmit={sendMessage}
        >
          <p className="text-[30px] sm:text-[40px] font-bold" data-aos="fade-left">
            {t("request")}
          </p>
